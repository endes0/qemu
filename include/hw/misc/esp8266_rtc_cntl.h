...
#define ESP8266_RTC_CNTL(obj) \
    OBJECT_CHECK(Esp8266RtcCntlState, (obj), TYPE_ESP8266_RTC_CNTL)

// From:
// https://github.com/espressif/ESP8266_RTOS_SDK/blob/d45071563cebe9ca520cbed2537dc840b4d6a1e6/components/esp8266/include/esp8266/rtc_register.h
...
REG32(RTC_UNK_REG, 0x8) // Unknown register. The bootrom put low (if high) the
                        // bit 21 after reading RTC_STATE2.
...
FIELD(RTC_INT_ENABLE, WAKEUP_STATE, 0,
      2) // Unknown register. pm_wait4wakeup will loop until this field > 0.
