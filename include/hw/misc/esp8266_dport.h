...
typedef struct Esp8266CacheState {
    ...
    bool is_1MB_offset; // If set, there is 1MB in the cache address space,
                        // otherwise 0MB
...
#define ESP8266_DPORT(obj) \
    OBJECT_CHECK(Esp8266DportState, (obj), TYPE_ESP8266_DPORT)
#define TYPE_ESP8266_CACHE_REGION "misc.esp8266.cache_region"
#define ESP8266_CACHE_REGION(obj) \
    OBJECT_CHECK(Esp8266CacheRegionState, (obj), TYPE_ESP8266_CACHE_REGION)
