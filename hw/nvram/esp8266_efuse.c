...
static uint64_t esp8266_efuse_read(void *opaque, hwaddr addr, unsigned int size)
{
    ...
    case A_EFUSE_DATA2:
        ...
        break;
    case A_EFUSE_DATA3:
        r = FIELD_DP32(r, EFUSE_DATA3, MAC0, mac[0] << 16 | mac[1] << 8 | mac[2]);
...
static void esp8266_efuse_write(void *opaque, hwaddr addr,
...
{
    Esp8266EfuseState *s = ESP8266_EFUSE(dev);
}*/
...
static Property esp8266_efuse_properties[] = {
    ...
    DEFINE_PROP_ARRAY("mac", Esp8266EfuseState, mac_size, mac, qdev_prop_uint8, uint8_t),
