/*
 * ESP8266 hdrf: Here lays some registers and the MMU for the SPI memory-mapping cache.
 *
 * Copyright (c) 2022
 *
...
static void esp8266_hdrf_write(void *opaque, hwaddr addr,
...
static const TypeInfo esp8266_hdrf_info = {
    .name = TYPE_ESP8266_HDRF,
    .parent = TYPE_SYS_BUS_DEVICE,
    .instance_size = sizeof(Esp8266HdrfState),
    .instance_init = esp8266_hdrf_init
};
